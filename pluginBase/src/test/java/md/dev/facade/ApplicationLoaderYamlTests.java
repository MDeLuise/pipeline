...
public class ApplicationLoaderYamlTests extends AbstractApplicationLoaderBaseTest {
    final String examplesPath = "src/main/resources/examples/yaml/%s.yaml";
    ...
    public void givenWrongFile_whenLoaded_thenExceptionThrown_0() {
        String pathExample = String.format(examplesPath, "example-wrong0");

        FileToPipelineConfigurationConverter.convert(new File(pathExample), applicationFactories);
    }

    @Test(expected = IncompatibleTypeException.class)
    public void givenWrongFile_whenLoaded_thenExceptionThrown_1() {
        String pathExample = String.format(examplesPath, "example-wrong1");

        FileToPipelineConfigurationConverter.convert(new File(pathExample), applicationFactories);
    }

    @Test(expected = IncompatibleTypeException.class)
    public void givenWrongFile_whenLoaded_thenExceptionThrown_2() {
        String pathExample = String.format(examplesPath, "example-wrong2");
