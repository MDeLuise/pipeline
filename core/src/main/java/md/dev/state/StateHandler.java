...
public class StateHandler {
    ...
    public static String getPropertyFromState(String stateId, String property) {
        LOGGER.info("required property {} of state {}", property, stateId);
    ...
    public static void savePropertyInState(String stateId, String property, String value) {
        LOGGER.info("saving property {} with stateId {}", property, stateId);
        PREFERENCES.put(stateId + property, value);
    }

    public static void removePropertyFromState(String stateId, String property) {
        LOGGER.info("removing property {} from state {}", property, stateId);
    ...
    public static void saveSensitivePropertyInState(
            String secretKey,
            String salt,
            String stateId,
            String property,
    ...
    public static String getSensitivePropertyFromState(
            String secretKey,
            String salt,
            String stateId,
            String property) {
